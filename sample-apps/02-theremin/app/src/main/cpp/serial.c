...
// Java_com_getcircuitbent_mabu_theremin_SerialPort_*. If you paste this into
...
Java_com_getcircuitbent_mabu_theremin_SerialPort_openTty(
 ...
 */
JNIEXPORT jint JNICALL
Java_com_getcircuitbent_mabu_theremin_SerialPort_writeBytes(
...
Java_com_getcircuitbent_mabu_theremin_SerialPort_closeTty(
